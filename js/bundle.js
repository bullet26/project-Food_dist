...
function showThanksModal (message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimerId); // ф-цию реализовали ранее, отвечает за открытие модального окна
...
(__webpack_require__(/*! es6-promise */ "../../../node_modules/es6-promise/dist/es6-promise.js").polyfill)();
        ...
        const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 50000); // открытие модального окна через заданное время  
